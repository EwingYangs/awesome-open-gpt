...
| ChatGPT-Command-02 | [aichat](https://github.com/sigoden/aichat) | 1.1k | All-in-one chat and copilot CLI that integrates 10+ AI platforms, including OpenAI, Azure-OpenAI, Gemini, VertexAI, Claude, Mistral, Cohere, Ollama, Ernie, Qianwen, Moonshot... | 1. Support character presets 2. Syntax highlighting markdown and 200 other languages |
...
| QQ AND Telegraph-ChatGPT-Robot | [OpenaiBot](https://github.com/LlmKira/Openaibot) | 1.4k | ⚡️ Build Your Own ChatGpt Bot|🧀 Discord/Slack/Kook/Telegram |🍓 复刻 ChatGpt 架构 |⛓ ToolCall|🔖 Plugin Support | 🌻 out-of-box | gpt-4-turbo | 🧀 Discord/Slack/Kook/Telegram |
