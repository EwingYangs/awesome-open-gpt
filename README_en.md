...
| ChatGPT-web Enhanced-05 | [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) | 11.1k | Come join the best place on the internet to learn AI skills. Use code "chatbotui" for an extra 20% off. | 1. Support Prompt template 2. Support search chat content 3. Support GPT-44. Support code highlighting 5. Support Markdown output |
...
| name | github address | star | introduction | function |
| --- | --- | --- | --- | --- |
| git tools-02 | [opencommit](https://github.com/di-sukharev/opencommit) | 3.0k | Generate conventional git commit messages with AI in 1 second 🤯🔫 | Automatically generate clear, comprehensive, and descriptive commit messages |
