...
| ChatGPT-web Enhanced-04 | [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) | 17.7k | ✨ Local and Fast AI Assistant. Support: Web | iOS | MacOS | Android | Linux | Windows | iOS |
...
| QQ-ChatGPT-Robot-01 | [chatgpt-mirai-qq-bot](https://github.com/lss233/chatgpt-mirai-qq-bot) | 4.7k | 🚀 一键部署！真正的 AI 聊天机器人！支持ChatGPT、DeepSeek、Claude、Gemini、ChatGLM、文心一言、讯飞星火，多账号，人设调教，虚拟女仆、图片渲染、语音发送 | 支持 QQ、Telegram、Discord、微信 等平台 | 支持 QQ、Telegram、Discord、微信 等平台 |
| QQ-ChatGPT-Robot-02 | [QChatGPT](https://github.com/RockChinQ/QChatGPT) | 2.2k | 😎丰富生态、🧩支持扩展、🦄多模态 - 大模型原生即时通信机器人平台 🤖 | 适配 QQ / QQ频道 / OneBot / Discord / 企业微信（wecom）/ 飞书（lark feishu） 等多种消息平台 | 支持 OpenAI GPT、ChatGPT、DeepSeek、Dify、Claude、Gemini、Ollama、LM Studio、Gitee AI、SiliconFlow、Qwen、Moonshot、ChatGLM、xAI 等 LLM 的机器人 / Agent 平台 | 适配 QQ / QQ频道 / OneBot / 企业微信（wecom）/ 飞书（lark feishu） 等多种消息平台 |
...
| [gpt4free🔥](https://github.com/xtekky/gpt4free) | 5.5k | The official gpt4free repository | various collection of powerful language models | gpt-4o and deepseek v3 & r1 | various collection of powerful language models |
