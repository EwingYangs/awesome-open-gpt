...
| [YiVal]( https://github.com/YiVal/YiVal) | 2k    |评估和增强企业级GenAI开发平台，为企业的AI开发和创新提供更强大的支持，能够快速轻松地管理、提示、监控和评估的大规模的AIGC App(模型+提示词）。 |1.数据输入：框架处理自动生成，或者选择手动数据输入。2.设置：自动化获得最佳设置，或者手动设置参数和提示变量。3.评估：利用内置的自动评估器获得高效的结果。4.增强：支持enhancer，自动提升prompt质量。                                                                                                                                                                                                                                                  |
