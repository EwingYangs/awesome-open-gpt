...
| [YiVal]( https://github.com/YiVal/YiVal) | 2k    |YiVal 是一个多功能平台和框架，可简化生成式 AI 应用程序的评估和增强。|YiVal能够使您轻松生成更好的结果、减少延迟并降低推理成本。 根据您的数据和使用感受，YiVal 将同时帮助您优化提示、模型元数据、模型参数和检索配置。 您可以一次性轻松定制您的测试数据、评估方法和增强策略。 轻松增强和评估一切！                                                                                                                                                                                                                                            |
